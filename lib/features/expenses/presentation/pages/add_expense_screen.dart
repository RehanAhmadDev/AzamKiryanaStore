...
class _AddExpenseScreenState extends ConsumerState<AddExpenseScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      // 🚀 DESKTOP FIX: Centered ConstrainedBox so form doesn't stretch
      body: Center(
          ...
          child: SingleChildScrollView(
            ...
            child: Column(
              ...
              children: [
                ...
                // Form Fields wrapped in a clean card for better UI
                Container(
                ...
                SizedBox(
                  ...
                  child: ElevatedButton(
                    style: ElevatedButton.styleFrom(
                      backgroundColor: isUpdating ? const Color(0xFF6366F1) : const Color(0xFF0F172A),
    ...
    return Column(
      children: [
        ...
        Container(
          ...
          decoration: BoxDecoration(
            color: const Color(0xFFF1F5F9), // Match TextField fillColor
